Shader "Custom/ParticleTransparentTextureEmission" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
			...
			void surf (Input IN, inout SurfaceOutputStandard o) {
				...
				o.Emission = IN.vertexColor.rgb; //Grab the color from ther verts. This will allow the particle system color to change!!
				//o.Emission = c.rgb;
			}
		ENDCG
	}
